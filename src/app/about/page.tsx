    ...
    <>
      <section className="bg-background py-24">
        <div className="container mx-auto max-w-4xl px-4 text-center md:px-6">
          <h1 className="font-exo text-4xl font-bold text-primary md:text-5xl">About Neroes</h1>
        </div>
      </section>

      <section className="bg-muted py-20">
        <div className="container mx-auto max-w-4xl space-y-6 px-4 text-center md:px-6">
          <h2 className="font-exo text-3xl font-bold text-primary">Our vision: human empowerment</h2>
